...
Highlight the last column in blue (with white text). This is done with `tab_style()`, with help from the `style` and `loc` modules (for style and location definition).
